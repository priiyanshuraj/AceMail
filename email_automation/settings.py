...
FIELD_ENCRYPTION_KEY = b'MTIzNDU2Nzg5MDEyMzQ1Njc4OTAxMjM0NTY3ODkwMTI='
...
# FORCE OVERRIDE: Hardcoded Secret Key for Local Development
SECRET_KEY = 'django-insecure-nuclear-option-key-for-testing-only'